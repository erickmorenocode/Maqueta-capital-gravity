...
export const SCENARIOS: MarketScenario[] = [
  {
    ...
    flows: [
      ...
      { from: 'Tech', to: 'Bonds', strength: 0.4, label: 'Cobertura de Riesgo' }
    ],
    metrics: {
      ...
      Tech: { masa: 60, distancia: 30, friccion: 10 },
  ...
  },
  {
    ...
    flows: [
      ...
      { from: 'Tech', to: 'Bonds', strength: 0.7, label: 'Demanda de Refugio (Bonds)' },
    ...
    metrics: {
      ...
      Tech: { masa: 50, distancia: 50, friccion: 10 },
  ...
  },
  {
    ...
    gravityCenters: ['Tech'],
    flows: [
      { from: 'Bonds', to: 'Tech', strength: 0.7, label: 'Demanda de Crecimiento (Nasdaq Up)' },
    ...
    metrics: {
      ...
      Tech: { masa: 95, distancia: 20, friccion: 5 },
  ...
  },
  {
    ...
    flows: [
      ...
      { from: 'Tech', to: 'Gold', strength: 0.8, label: 'Refugio Seguro' },
      { from: 'Tech', to: 'Bonds', strength: 0.8, label: 'Preservación de Liquidez' },
    ...
    metrics: {
      ...
      Tech: { masa: 15, distancia: 90, friccion: 15 },
  ...
  },
  {
    ...
    gravityCenters: ['Tech'],
    flows: [
      { from: 'USD', to: 'Tech', strength: 0.9, label: 'Prima de Innovación' },
    ...
    metrics: {
      ...
      Tech: { masa: 98, distancia: 15, friccion: 5 },
...
export const GEO_POINTS: GeoPoint[] = [
  ...
  { id: 'Tech', name: 'TECNOLOGÍA', coordinates: [-122, 37], type: 'asset' },
