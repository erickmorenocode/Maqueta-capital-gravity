...
export const COUNTRY_SECTOR_COMPANIES: Record<string, Record<string, CompanyRecommendation[]>> = {
  ...
  'Canadá': {
    technology:         [{ ticker:'SHOP', name:'Shopify' },{ ticker:'CSU', name:'Constellation Software' },{ ticker:'OTEX', name:'Open Text' },{ ticker:'BB', name:'BlackBerry' },{ ticker:'KXS', name:'Kinaxis' },{ ticker:'DSGX', name:'Descartes Systems' },{ ticker:'LSPD', name:'Lightspeed Commerce' },{ ticker:'GIB.A', name:'CGI Group' },{ ticker:'DCBO', name:'Docebo' },{ ticker:'MDA', name:'MDA Space' }],
    communication:      [{ ticker:'BCE', name:'Bell Canada' },{ ticker:'T', name:'TELUS' },{ ticker:'RCI.B', name:'Rogers Communications' },{ ticker:'QBR.B', name:'Quebecor' },{ ticker:'MAXR', name:'Maxar Technologies' },{ ticker:'CGO', name:'Cogeco' },{ ticker:'RAY.A', name:'Stingray Group' },{ ticker:'CJR.B', name:'Corus Entertainment' },{ ticker:'SFTC', name:'Softchoice' },{ ticker:'PHO', name:'Photon Control' }],
    cons_discretionary: [{ ticker:'DOL', name:'Dollarama' },{ ticker:'CTC.A', name:'Canadian Tire' },{ ticker:'QSR', name:'Restaurant Brands' },{ ticker:'GIL', name:'Gildan Activewear' },{ ticker:'DOO', name:'BRP' },{ ticker:'LULU', name:'Lululemon' },{ ticker:'MTY', name:'MTY Food Group' },{ ticker:'ATZ', name:'Aritzia' },{ ticker:'TOY', name:'Spin Master' },{ ticker:'ROOT', name:'Roots' }],
    cons_staples:       [{ ticker:'L', name:'Loblaw Companies' },{ ticker:'EMP.A', name:'Empire Company' },{ ticker:'MRU', name:'Metro' },{ ticker:'ATD', name:'Alimentation Couche-Tard' },{ ticker:'WN', name:'George Weston' },{ ticker:'PBH', name:'Premium Brands' },{ ticker:'NWC', name:'North West Company' },{ ticker:'HLF', name:'High Liner Foods' },{ ticker:'ADW.A', name:'Andrew Peller' },{ ticker:'VFF', name:'Village Farms' }],
    energy:             [{ ticker:'SU', name:'Suncor Energy' },{ ticker:'CNQ', name:'Canadian Natural Resources' },{ ticker:'CVE', name:'Cenovus Energy' },{ ticker:'IMO', name:'Imperial Oil' },{ ticker:'TOU', name:'Tourmaline Oil' },{ ticker:'ARX', name:'Arc Resources' },{ ticker:'PPL', name:'Pembina Pipeline' },{ ticker:'TRP', name:'TC Energy' },{ ticker:'KEY', name:'Keyera' },{ ticker:'BTE', name:'Baytex Energy' }],
    financial:          [{ ticker:'RY', name:'Royal Bank of Canada' },{ ticker:'TD', name:'TD Bank' },{ ticker:'BNS', name:'Scotiabank' },{ ticker:'BMO', name:'Bank of Montreal' },{ ticker:'CM', name:'CIBC' },{ ticker:'MFC', name:'Manulife Financial' },{ ticker:'SLF', name:'Sun Life Financial' },{ ticker:'IFC', name:'Intact Financial' },{ ticker:'FFH', name:'Fairfax Financial' },{ ticker:'GWO', name:'Great-West Lifeco' }],
    healthcare:         [{ ticker:'BHC', name:'Bausch Health' },{ ticker:'JWEL', name:'Jamieson Wellness' },{ ticker:'WELL', name:'Well Health Technologies' },{ ticker:'CSH.UN', name:'Chartwell Retirement' },{ ticker:'SIA', name:'Sienna Senior Living' },{ ticker:'AND', name:'Andlauer Healthcare' },{ ticker:'EXE', name:'Extendicare' },{ ticker:'NBLY', name:'Neighbourly Pharmacy' },{ ticker:'CURA', name:'Curaleaf Holdings' },{ ticker:'TRST', name:'CannTrust' }],
    industrials:        [{ ticker:'CP', name:'Canadian Pacific Kansas City' },{ ticker:'CNR', name:'Canadian National Railway' },{ ticker:'WCN', name:'Waste Connections' },{ ticker:'WSP', name:'WSP Global' },{ ticker:'ATRL', name:'AtkinsRéalis' },{ ticker:'FTT', name:'Finning International' },{ ticker:'CAE', name:'CAE' },{ ticker:'EIF', name:'Exchange Income' },{ ticker:'NFI', name:'NFI Group' },{ ticker:'BIP.UN', name:'Brookfield Infrastructure' }],
    real_estate:        [{ ticker:'BAM', name:'Brookfield Asset Management' },{ ticker:'CAR.UN', name:'Canadian Apartment REIT' },{ ticker:'REI.UN', name:'RioCan REIT' },{ ticker:'GRT.UN', name:'Granite REIT' },{ ticker:'AP.UN', name:'Allied REIT' },{ ticker:'CHP.UN', name:'Choice Properties' },{ ticker:'SRU.UN', name:'SmartCentres REIT' },{ ticker:'D.UN', name:'Dream Office REIT' },{ ticker:'FCR.UN', name:'First Capital REIT' },{ ticker:'HR.UN', name:'H&R REIT' }],
    basic_materials:    [{ ticker:'ABX', name:'Barrick Gold' },{ ticker:'AEM', name:'Agnico Eagle Mines' },{ ticker:'K', name:'Kinross Gold' },{ ticker:'WPM', name:'Wheaton Precious Metals' },{ ticker:'FM', name:'First Quantum Minerals' },{ ticker:'TECK.B', name:'Teck Resources' },{ ticker:'NTR', name:'Nutrien' },{ ticker:'LUN', name:'Lundin Mining' },{ ticker:'IVN', name:'Ivanhoe Mines' },{ ticker:'PAAS', name:'Pan American Silver' }],
    utilities:          [{ ticker:'FTS', name:'Fortis' },{ ticker:'AQN', name:'Algonquin Power & Utilities' },{ ticker:'EMA', name:'Emera' },{ ticker:'H', name:'Hydro One' },{ ticker:'NPI', name:'Northland Power' },{ ticker:'CPX', name:'Capital Power' },{ ticker:'BLX', name:'Boralex' },{ ticker:'INE', name:'Innergex Renewable' },{ ticker:'TA', name:'TransAlta' },{ ticker:'ACO.X', name:'ATCO' }],
  },
  'Francia': {
    technology:         [{ ticker:'CAP.PA', name:'Capgemini' },{ ticker:'DSY.PA', name:'Dassault Systèmes' },{ ticker:'WLN.PA', name:'Worldline' },{ ticker:'TEP.PA', name:'Teleperformance' },{ ticker:'SOP.PA', name:'Sopra Steria' },{ ticker:'HO.PA', name:'Thales' },{ ticker:'ATO.PA', name:'Atos' },{ ticker:'UBI.PA', name:'Ubisoft' },{ ticker:'ALTEN.PA', name:'Alten' },{ ticker:'AKA.PA', name:'Akka Technologies' }],
    ...
    cons_staples:       [{ ticker:'BN.PA', name:'Danone' },{ ticker:'CA.PA', name:'Carrefour' },{ ticker:'OR.PA', name:'L\'Oréal' },{ ticker:'RCO.PA', name:'Rémy Cointreau' },{ ticker:'BON.PA', name:'Bonduelle' },{ ticker:'FBEL.PA', name:'Bel Group' },{ ticker:'LDC.PA', name:'LDC (Poulets)' },{ ticker:'GAIA.PA', name:'Gaia' },{ ticker:'FLEM.PA', name:'Fleury Michon' },{ ticker:'MDP.PA', name:'MDP' }],
    ...
    real_estate:        [{ ticker:'URW.PA', name:'Unibail-Rodamco-Westfield' },{ ticker:'ICAD.PA', name:'Icade' },{ ticker:'GFC.PA', name:'Gecina' },{ ticker:'COV.PA', name:'Covivio' },{ ticker:'LI.PA', name:'Klépierre' },{ ticker:'MERY.PA', name:'Mercialys' },{ ticker:'ARG.PA', name:'Argan' },{ ticker:'PAT.PA', name:'Patrimoine & Commerce' },{ ticker:'ALREI.PA', name:'Altarea' },{ ticker:'FDE.PA', name:'Foncière des Murs' }],
    basic_materials:    [{ ticker:'AI.PA', name:'Air Liquide' },{ ticker:'AKE.PA', name:'Arkema' },{ ticker:'ERA.PA', name:'Eramet' },{ ticker:'NK.PA', name:'Imerys' },{ ticker:'VCT.PA', name:'Vicat' },{ ticker:'BVI.PA', name:'Bureau Veritas' },{ ticker:'SESG.PA', name:'SES-imagotag' },{ ticker:'MLCOU.PA', name:'Courtois' },{ ticker:'SFCA.PA', name:'Soitec' },{ ticker:'NXT.PA', name:'Nexans' }],
  ...
  'Alemania': {
    ...
    cons_staples:       [{ ticker:'HEN3.DE', name:'Henkel' },{ ticker:'BEI.DE', name:'Beiersdorf' },{ ticker:'SY1.DE', name:'Symrise' },{ ticker:'RAA.DE', name:'Rational AG' },{ ticker:'B4B.DE', name:'Metro AG' },{ ticker:'FRE.DE', name:'Fresenius' },{ ticker:'KWS.DE', name:'KWS Saat' },{ ticker:'SDF.DE', name:'K+S (Düngemittel)' },{ ticker:'MTAR.DE', name:'ATOSS Software' },{ ticker:'EVD.DE', name:'CTS Eventim' }],
    energy:             [{ ticker:'RWE.DE', name:'RWE' },{ ticker:'EOAN.DE', name:'E.ON' },{ ticker:'ENR.DE', name:'Siemens Energy' },{ ticker:'NDX1.DE', name:'Nordex' },{ ticker:'ECV.DE', name:'Encavis' },{ ticker:'PNE.DE', name:'PNE Wind' },{ ticker:'UN01.DE', name:'Uniper' },{ ticker:'VBK.VI', name:'Verbund' },{ ticker:'2G1.DE', name:'2G Energy' },{ ticker:'MVVN.DE', name:'MVV Energie' }],
    ...
    industrials:        [{ ticker:'SIE.DE', name:'Siemens' },{ ticker:'TKA.DE', name:'Thyssenkrupp' },{ ticker:'HDMG.DE', name:'Heidelberg Materials' },{ ticker:'DTG.DE', name:'Daimler Truck' },{ ticker:'KBX.DE', name:'Knorr-Bremse' },{ ticker:'KGX.DE', name:'KION Group' },{ ticker:'WCH.DE', name:'Wacker Chemie' },{ ticker:'DUE.DE', name:'Dürr' },{ ticker:'AIXA.DE', name:'Aixtron' },{ ticker:'DHER.DE', name:'Delivery Hero' }],
    real_estate:        [{ ticker:'VNA.DE', name:'Vonovia' },{ ticker:'LEG.DE', name:'LEG Immobilien' },{ ticker:'AT1.DE', name:'Aroundtown' },{ ticker:'GYC.DE', name:'Grand City Properties' },{ ticker:'INS1.DE', name:'Instone Real Estate' },{ ticker:'DEQ.DE', name:'Deutsche EuroShop' },{ ticker:'ADJ.DE', name:'ADO Properties' },{ ticker:'HAL.DE', name:'Hamborner REIT' },{ ticker:'DWNI.DE', name:'Deutsche Wohnen' },{ ticker:'VIB3.DE', name:'VIB Vermögen' }],
    basic_materials:    [{ ticker:'BAS.DE', name:'BASF' },{ ticker:'1COV.DE', name:'Covestro' },{ ticker:'LXS.DE', name:'Lanxess' },{ ticker:'EVK.DE', name:'Evonik' },{ ticker:'BNR.DE', name:'Brenntag' },{ ticker:'NDA.DE', name:'Aurubis' },{ ticker:'SDF.DE', name:'K+S' },{ ticker:'CEL.DE', name:'Celanese' },{ ticker:'WWIN.DE', name:'Wincor Nixdorf' },{ ticker:'SYK.DE', name:'Symrise' }],
    utilities:          [{ ticker:'EOAN.DE', name:'E.ON' },{ ticker:'RWE.DE', name:'RWE' },{ ticker:'ENR.DE', name:'Siemens Energy' },{ ticker:'ECV.DE', name:'Encavis' },{ ticker:'NDX1.DE', name:'Nordex' },{ ticker:'UN01.DE', name:'Uniper' },{ ticker:'MVVN.DE', name:'MVV Energie' },{ ticker:'2G1.DE', name:'2G Energy' },{ ticker:'PNE.DE', name:'PNE' },{ ticker:'ABO.DE', name:'ABO Wind' }],
  },
  'Italia': {
    ...
    industrials:        [{ ticker:'LDO.MI', name:'Leonardo' },{ ticker:'FCT.MI', name:'Fincantieri' },{ ticker:'PRY.MI', name:'Prysmian' },{ ticker:'IP.MI', name:'Interpump Group' },{ ticker:'CNHI', name:'CNH Industrial' },{ ticker:'BZU.MI', name:'Buzzi Unicem' },{ ticker:'DAL.MI', name:'Datalogic' },{ ticker:'BRE.MI', name:'Brembo' },{ ticker:'BSS.MI', name:'Biesse Group' },{ ticker:'CEM.MI', name:'Cementir Holding' }],
    real_estate:        [{ ticker:'CRES.MI', name:'Coima RES' },{ ticker:'IGD.MI', name:'IGD SIIQ' },{ ticker:'AED.MI', name:'Aedes SIIQ' },{ ticker:'COV.PA', name:'Covivio (ex Beni Stabili)' },{ ticker:'PRLI.MI', name:'Prelios' },{ ticker:'RS.MI', name:'Risanamento' },{ ticker:'GAB.MI', name:'Gabetti Property' },{ ticker:'AREIT.MI', name:'Altareit' },{ ticker:'VFG.MI', name:'Valsoia' },{ ticker:'L.MI', name:'Leasinvest' }],
